...
--1
/*
    Procedimiento mostrar_fecha. Introduce dos valores que corresponden a un
        rango de fechas. Dadas las fechas escribe en pantalla los músicos y
        sus obras más famosas con sus respectivos géneros con un cursor.
*/
...
--2
/*
    Procedimiento mostrar_info. Introduce el nombre de un músico y
        muestra todas sus obras junto con la fecha de creación con un cursor.
*/
...
--3
/*
    Función ciento_gen. Introduce un género y un músico, si hay
        relación devolverá un número entero que es el porcentaje de obras de
        ese género del músico en cuestión, si no hay relación devolverá un 0.
*/
...
/*
    ...
    muestra el género y el porcentaje de obras que ha realizado
    sobre ese género con un cursor.
*/
...
--5
/*
    Función ent_dis. Introduce el ID de un evento y devuelve un
        número que son las entradas libres del evento
        (Aforo ocupado - Aforo total).
*/
...
--6
/*
    Procedimiento crear_ent. Haciendo uso de la función ent_dis,
        si existe aforo libre se introducirá el DNI del cliente y se
        creará una entrada. Al finalizar mostrará las entradas libres
        que quedan, por el contrario mostrará un mensaje de error.
*/
...
--7
/* 
    Disparador de fila act_cli. Se lanza después de insertar una entrada.
...
--8
/*
    Disparador de fila ctrl_cli. Hace un control de los clientes y la
        tabla Actualizar. Si el cliente que se actualiza tenía el nombre
        o el apellido vacío se eliminará el DNI correspondiente de la
        tabla ACTUALIZAR.
*/
...
--9
/*
    Disparador de instrucción «denegar». Controla que no se pueda hacer
        ninguna operación en las entradas mientras sea festivo nacional.
*/
